...
public class MiningBeeModel extends BeeModel<CustomBeeEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition2.addOrReplaceChild("helmet_top",
                CubeListBuilder.create()
                        .texOffs(36, 58).addBox(-4.0F, 1.0F, -1.0F, 9.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
                        .texOffs(36, 10).addBox(-3.0F, -1.0F, 0.0F, 7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                        .texOffs(39, 20).addBox(-2.0F, -2.0F, 1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-0.5F, -5.0F, -5.0F));
    ...
    public void setupAnim(CustomBeeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        ModelPart helmet = this.body.getChild("helmet_top");
