...
public class LightBeeModel extends BeeModel<CustomBeeEntity> {
    ...
    public LightBeeModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition2.addOrReplaceChild(
                "light", CubeListBuilder.create().texOffs(24, 6).addBox(-4.0F, -5.0F, -6.0F, 8.0F, 9.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.0F, 0.0F)
        );
    ...
    public void setupAnim(CustomBeeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        light.xRot = this.body.xRot;
        light.yRot = this.body.yRot;
        light.zRot = this.body.zRot;
        light.x = this.body.x;
        light.y = this.body.y;
        light.z = this.body.z;
    }
