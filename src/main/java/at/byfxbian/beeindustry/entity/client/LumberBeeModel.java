...
public class LumberBeeModel extends BeeModel<CustomBeeEntity> {
    ...
    public LumberBeeModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition2.addOrReplaceChild("lumber", CubeListBuilder.create().texOffs(52, 0).addBox(-2.0F, -2.0F, 1.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(38, 5).addBox(-3.0F, -7.0F, 0.0F, 8.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(42, 7).addBox(-2.0F, -8.0F, 1.0F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 3.0F, -6.0F));
    ...
    public void setupAnim(CustomBeeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        ModelPart lumber = this.body.getChild("lumber");
        lumber.xRot = this.body.xRot;
        lumber.yRot = this.body.yRot;
        lumber.zRot = this.body.zRot;
        //lumber.x = this.body.x;
        //lumber.y = this.body.y;
       // lumber.z = this.body.z;
    }
}
