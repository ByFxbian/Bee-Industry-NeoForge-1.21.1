...
public class DrippingBeeModel extends BeeModel<CustomBeeEntity> {
    ...
    public DrippingBeeModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition2.addOrReplaceChild(
                "drips", CubeListBuilder.create().texOffs(60, 6).addBox(-3.0F, 3.0F, -1.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(60, 0).addBox(0.0F, 3.0F, -4.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(56,0).addBox(2.0F, 3.0F, 1.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
    ...
    public void setupAnim(CustomBeeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        ModelPart drips = this.body.getChild("drips");
        drips.xRot = this.body.xRot;
        drips.yRot = this.body.yRot;
        drips.zRot = this.body.zRot;
        drips.x = this.body.x;
        drips.y = this.body.y;
        drips.z = this.body.z;
    }
